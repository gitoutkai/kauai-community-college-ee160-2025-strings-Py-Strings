...
course= """
Kaihehau Goo Strings
Kaihehau Goo Strings is a Python script that generates a list of strings based on the input string.
...
It doesn’t try to be emotiona. It leans into being a fun, flashy action-comedy that’s more about
